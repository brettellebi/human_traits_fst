...
# Run again on SNPs from *Lee et al (2019)*
...
grep "<b>\w</b>" data/20200304_raw_associations_height.csv > data/20200304_raw_associations_height.csv
# pull out risk alleles only 
```
