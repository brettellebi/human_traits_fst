...
* Working directory on EBI Cluster: `/hps/research1/birney/users/ian/hmn_fst`
* GitHub repository: <https://github.com/brettellebi/human_traits_fst>

## `conda` env for cluster
...
```{r, engine='bash', eval = F}
find vcfs/ftp.1000genomes.ebi.ac.uk/ALL.chr*.vcf.gz > human_traits_fst/data/20200205_vcfs.list
```
...
gatk SelectVariants \
  ...
  --keep-ids human_traits_fst/data/20200316_snps_eduyears.list \
...
```{r, engine='bash', eval = F}
cut -f1 human_traits_fst/data/20181015_Yengo-et-al_snps_height.txt | tail -n+2 > human_traits_fst/data/20200318_snps_height.list
```
...
gatk SelectVariants \
  -R refs/hs37d5.fa.gz \
  -V vcfs/1gk_all.vcf.gz \
  --keep-ids human_traits_fst/data/20200318_snps_height.list \
...
gatk SelectVariants \
  -R refs/hs37d5.fa.gz \
  -V vcfs/1gk_all.vcf.gz \
  --keep-ids human_traits_fst/data/20200319_snps_ibd.list \
...
gatk SelectVariants \
  -R refs/hs37d5.fa.gz \
  -V vcfs/1gk_all.vcf.gz \
  --keep-ids human_traits_fst/data/20200622_snps_pig.list \
...
```{r, engine='bash', eval = F}
mkdir human_traits_fst/data/20200622_plink2_alfreqs
mkdir human_traits_fst/data/20200622_plink2_alfreqs/hei
mkdir human_traits_fst/data/20200622_plink2_alfreqs/edu
mkdir human_traits_fst/data/20200622_plink2_alfreqs/ibd
mkdir human_traits_fst/data/20200622_plink2_alfreqs/pig
```
...
/nfs/software/birney/plink2.3/plink2 \
  ...
  --loop-cats PHENO1 \
  --out human_traits_fst/data/20200622_plink2_alfreqs/edu/edu
...
/nfs/software/birney/plink2.3/plink2 \
  ...
  --pheno iid-only human_traits_fst/data/plink2_sample_popn_key.txt \
  --loop-cats PHENO1 \
  --out human_traits_fst/data/20200622_plink2_alfreqs/hei/hei
...
/nfs/software/birney/plink2.3/plink2 \
  ...
  --pheno iid-only human_traits_fst/data/plink2_sample_popn_key.txt \
  --loop-cats PHENO1 \
  --out human_traits_fst/data/20200622_plink2_alfreqs/ibd/ibd
...
/nfs/software/birney/plink2.3/plink2 \
  ...
  --pheno iid-only human_traits_fst/data/plink2_sample_popn_key.txt \
  --loop-cats PHENO1 \
  --out human_traits_fst/data/20200622_plink2_alfreqs/pig/pig
```
