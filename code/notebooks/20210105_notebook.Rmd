...
trait_levels = c("hei", "bmi", "edu", "ibd", "pig")
...
recode_vec = c("hei" = "Height",
               ...
               "pig" = "Pigmentation")
# Colour palette
fill_pal_primary = c("Height" = "#FFBF00",
                     "BMI" = "#0bc166",
                     "Educational attainment" = "#00afbb",
                     "IBD" = "#360568",
                     "Pigmentation" = "#fc4e07")
fill_pal_secondary = c("Height" = "#cc7e08",
                       "BMI" = "#026a7a",
                       "Educational attainment" = "#02395c",
                       "IBD" = "#651375",
                       "Pigmentation" = "#a11f1f")
```
...
* 20171130_Martin-et-al: **Martin et al. (2017)** An Unexpectedly Complex Architecture for Skin Pigmentation in Africans, *Cell*: <https://www.cell.com/cell/fulltext/S0092-8674%2817%2931324-7>. 
...
* 20190321_Jonnalagadda-et-al: **Jonnalagadda et al. (2019)** A Genome-Wide Association Study of Skin and Iris Pigmentation among Individuals of South Asian Ancestry, *Genome Biology and Evolution*: <https://academic.oup.com/gbe/article/11/4/1066/5416147>. 
...
- Identified **9** SNPs associated with iris colour from Table 1. Embedded in paper, so copied manually.
...
### Create lists of target SNPs and generate Manhattan plots

Create function for Manhattan plotting

```{r}
get_man <- function(df, trait, chr, bp, snp, p){
  # Replace p-values of 0 with the next lowest (because it can't plot 0 on a negative-log scale)
  df$P[df[[p]] == 0] = sort(df[[p]][df[[p]] != 0])[1]
