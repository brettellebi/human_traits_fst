...
* Working directory on EBI Cluster: `/hps/research1/birney/users/ian/hum_fst`
...
mamba create -y -n fst_env r
conda activate fst_env
mamba install -y -c r rstudio r-tidyverse 
mamba install -y -c conda-forge r-here r-plotly r-ggridges r-pegas
mamba install -y -c bioconda gatk4
# Export
conda env export --no-builds -f envs/fst_env.yml
```
